...
class PDFPreview extends StatefulWidget {
  ...
  const PDFPreview({super.key, this.metodePembayaran, this.nomorResi, this.nomorPO, this.namaCustomer, this.saldoJatuhTempo, this.tanggalJatuhTempo, this.totalPembayaran, this.biaya, this.hargaBuku, this.jumlahBuku, this.judulBuku, this.kodeBuku, this.totalSemua});
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: ()async{
          ...
          setState(() {
            this.bytes = bytes;
            // File('${Directory('/storage/emulated/0/Download').path}/invoice-${DateTime.now().microsecond}.jpg').writeAsBytes(this.bytes!);
          });
